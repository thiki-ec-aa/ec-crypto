...
fun main(args: Array<String>): Unit = exitProcess(CommandLine(CrypterApp()).execute(*args))
...
//    lateinit var command: String
    ...
    companion object {
        private val logger = LoggerFactory.getLogger(CrypterApp::class.java)
    }
